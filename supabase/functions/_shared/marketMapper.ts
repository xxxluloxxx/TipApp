...
// pick/market ya normalizados + threshold/selector — usado tanto por
// ocr-betslip (preview de legs) como, indirectamente, por el motor de
// reglas (betRuleEngine.ts) que consume el mismo threshold/selector.
// =============================================================================
